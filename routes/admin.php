...
Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('student')->middleware(['auth', 'role:admin'])->name('student.')->group(function () {
                ...
                Route::get('/', [StudentController::class, 'listStudent'])->name('index');

                Route::get('/add', [StudentController::class, 'add'])->name('add');

                Route::post('/add', [StudentController::class, 'postAdd'])->name('post-add');

                Route::get('/list', [StudentController::class, 'listStudent'])->name('list');

               

                Route::get('/edit/{student}', [StudentController::class, 'edit'])->name('edit');

                Route::post('/edit/{student}', [StudentController::class, 'postedit'])->name('post-edit');
