        ...
        <div class="container container-edit">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div style="margin-top: 58px;" class="teachers-left">
                        <div class="hero">
                        ...
                        <ul class="nav nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="active" id="dashboard-tab" data-toggle="tab" href="#dashboard" role="tab"
                                    aria-controls="dashboard" aria-selected="true">Tổng quan</a>
                            </li>
                            <li class="nav-item">
                                <a id="courses-tab" data-toggle="tab" href="#courses" role="tab" aria-controls="courses"
                                    aria-selected="false">Khóa học</a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <div class="col-md-6">
                                            <div class="singel-course mt-30">
                                                ...
                                                <div class="cont">
                                                    ...
                                                    <a href="{{ route('courses.courseDetail', $course) }}">
                                                        <h4>{{$course->name}}</h4>
                                                    </a>
