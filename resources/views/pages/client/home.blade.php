                                    ...
                                    <div class="singel-course">
                                        ...
                                        <div class="cont">
                                            ...
                                            <div class="course-teacher">
                                                <div class="thum">
                                                    <a href="{{ route('teachers.teacherDetail',$course->teacher) }}"><img src="{{ asset('storage/'.$course->teacher->image_path)  }}"
                                                            alt="teacher"></a>
                                                </div>
                                                <div class="name">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="singel-course">
                                    ...
                                    <div class="cont">
                                        ...
                                        <div class="course-teacher">
                                            <div class="thum">
                                                <a href="{{ route('teachers.teacherDetail',$course->teacher) }}"><img src="{{ asset('storage/'.$course->teacher->image_path)  }}" alt="teacher"></a>
                                            </div>
                                            <div class="name">
                                                <a href="{{ route('teachers.teacherDetail',$course->teacher) }}">
                                                    <h6>{{ $course->teacher->name }}</h6>
                                    ...
                                    <div class="col-sm-6 ">
                                        <div class="singel-teachers mt-30 text-center">
                                            <div class="image  card-teacher">
                                                <img src="{{ asset('storage/'.$teacher->image_path)  }}" alt="Teacher">
                                            </div>
                                            <div class="cont">
